...
$query = mysqli_query($conn,"SELECT lat,lon FROM vaccicenters where no= '".$chk."'");
...
<button onclick = redi() id="btdre" class="btde"><i class="fas fa-hospital"></i> Change Location </button>
<script>
...
function redi()
{
  window.location.href = "vaccinetrack(GoogleAPI).php";
}
</script>
<?php include 'vacmapdetails.php'?>
</body>
