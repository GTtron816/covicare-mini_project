...
if(mysqli_num_rows($result)==0)
{
 ...
 <form method="post" action="medupvac.php" id=myform>
...
<button  onclick="location.href ='vacuploc.php'" class="btde"><i class="fas fa-pen-alt"></i><span id="txt"> Update Location</span></button>
